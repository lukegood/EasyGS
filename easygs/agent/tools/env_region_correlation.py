"""Cross-region environmental correlation and heatmap analysis tool."""
...
@dataclass
class PreparedEnvRegionCorrelationRun:
    """Prepared cross-region environmental correlation execution plan."""
...
class RunEnvRegionCorrelationTool(PlinkToolBase, Tool):
    """Compute region-to-region correlations from combined environmental factors."""
    ...
    def __init__(self, workspace: Path, restrict_to_workspace: bool = False, timeout: int = 3600):
        super().__init__(
            ...
            timeout,
            skill_name="env_region_correlation_analysis",
            default_output_subdir="env_region_correlation",
            env_name="EasyGS_1",
        )
        self.script_path = self.skill_dir / "env_region_correlation.sh"
        self.r_script_path = self.skill_dir / "env_region_correlation_heatmap.R"
        self.summary_script_path = self.skill_dir / "summarize_env_region_correlation.py"

    @property
    def name(self) -> str:
        return "run_env_region_correlation"

    @property
    def description(self) -> str:
        return (
            "Compute the correlation matrix between regions after combining their environmental "
            "factor profiles from an env.csv-style file, then render a heatmap PDF."
        )
            ...
            "properties": {
                ...
                "output_dir": {
                    ...
                    "description": (
                        ...
                        "workspace/default_results/env_region_correlation/."
                    ),
                },
                "prefix": {
                    "type": "string",
                    "description": (
                        "Basename for outputs. Defaults to '各地区原始环境相关性', producing "
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        if run_result["returncode"] != 0:
            ...
            return (
                "Error: Cross-region environmental correlation analysis failed.\n"
        ...
        lines = [
            "Cross-region environmental correlation analysis completed.",
    ...
    async def prepare_run(
        ...
        *,
        ...
        return PreparedEnvRegionCorrelationRun(
