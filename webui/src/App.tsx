...
const SIDEBAR_STORAGE_KEY = "easygs-webui.sidebar";
    ...
    return (
      <div className="flex h-full w-full items-center justify-center">
        <div className="flex flex-col items-center gap-3 animate-in fade-in-0 duration-300">
          <img
            src="/brand/easygs_icon.png"
            alt=""
            className="h-14 w-auto max-w-10 animate-pulse select-none object-contain"
            aria-hidden
            draggable={false}
          />
      ...
      <div className="flex h-full w-full items-center justify-center px-4 text-center">
        <div className="flex max-w-md flex-col items-center gap-3">
          <img
            src="/brand/easygs_icon.png"
            alt=""
            className="h-14 w-auto max-w-10 object-contain opacity-60 grayscale select-none"
            aria-hidden
            draggable={false}
          />
